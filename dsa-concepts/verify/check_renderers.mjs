...
const ANIM_FIXTURES = {
  ...
  'graph-walk:frontier-queue': { type: 'graph-walk', unit: 90, frontier: 'queue',
    frontierLabel: 'the queue', countLabel: ' reached',
    nodes: [{ id: 'a', label: 'a', x: 0, y: 0 }, { id: 'b', label: 'b', x: 1, y: 0 }, { id: 'c', label: 'c', x: 2, y: 0 }],
    edges: [{ from: 'a', to: 'b' }, { from: 'b', to: 'c' }],
    steps: [{ look: ['a'], dead: ['b', 'c'], edges: [], count: 1, frontier: ['a'], badge: 'serve a' },
            { seen: ['a'], look: ['b'], dead: ['c'], edges: ['a-b'], count: 2, frontier: ['b'], badge: 'b waited longest' }] },
  'graph-walk:frontier-stack': { type: 'graph-walk', unit: 90, frontier: 'stack',
    frontierLabel: 'the stack', countLabel: ' reached',
    nodes: [{ id: 'a', label: 'a', x: 0, y: 0 }, { id: 'b', label: 'b', x: 1, y: 0 }, { id: 'c', label: 'c', x: 2, y: 0 }],
    edges: [{ from: 'a', to: 'b' }, { from: 'b', to: 'c' }],
    steps: [{ look: ['a'], dead: ['b', 'c'], edges: [], count: 1, frontier: ['a'], badge: 'take a' },
            { seen: ['a'], look: ['b'], dead: ['c'], edges: ['a-b'], count: 2, frontier: ['c', 'b'], badge: 'b went on last' }] },
