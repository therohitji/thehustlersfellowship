...
"1.1": `<div class="wrap">
  ...
  <p>Picture a wall of post boxes in an apartment building. Thousands of them, identical, each with a number painted on it. You are holding a slip with <em class="k">1048</em> written on it. You do not read every box. You do not start at box one and count. You walk to 1048 and open it.</p>
  ...
  <p>Your phone does not hold a photo as a photo. The moment it opens one, it holds a very long row of numbers, three per pixel, and something else agrees to interpret that row as an image. Text is a row of character codes. A song is a row of amplitude samples. <strong>The row is not a detail of the implementation. It is the only thing that exists.</strong></p>
  ...
  <p><strong>The answer.</strong> <strong>The answer.</strong> The grid draws a full page of tiles only once a user has 100 photos or more, and that page loop runs from box 0 to box 100, which is 101 boxes. A row of 100 photos has boxes numbered 0 to 99, so box 100 is not there and the app falls over. A user with 101 photos does have a box 100, so the read lands. A user with 99 never draws a full page at all. Somebody read the page size of 100 as the name of the last box rather than as the count of boxes.</p>
  ...
  <div class="quiz" data-correct="1">
    ...
    <div class="qexp">Start plus position times width. Three operations, and none of them mention how long the row is. This is one of the very few operations in the entire course that is genuinely free at any scale, and it is free for a boring reason: the boxes are the same size and they are in order.</div>
  </div>
...
"1.2": `<div class="wrap">
  ...
  <div class="viz" data-viz='{"type":"seq","title":"What actually passes when you follow a link","actors":[{"label":"Your program","kind":"gold"},{"label":"The runtime","kind":"accent"},{"label":"Memory","kind":"muted"}],"messages":[{"from":0,"to":1,"label":"give me the third item in the chain","style":"gold"},{"from":1,"to":2,"label":"which box holds the third item"},{"from":2,"to":1,"label":"I only answer read box N. Third means nothing"},{"from":1,"to":2,"label":"then read the box the handle names","style":"green"},{"from":2,"to":1,"label":"a value, and one number: box 2096","style":"green"},{"from":1,"to":2,"label":"read box 2096","style":"green"},{"from":2,"to":1,"label":"a value, and the number of the third node","style":"green"},{"from":1,"to":0,"label":"one more read gets it. There is no shortcut","style":"green"}],"caption":"Nothing that crosses this diagram is a connection. Memory refuses the one question that would have been a shortcut, and after that every arrow it answers carries a single thing: a box number going down, or the contents of that box coming back. The number of the third node exists in exactly one place in the machine, inside the second one. That is the mechanical reason a chain has to be walked, and the same fact is why inserting at the front costs two edits: write one new node, rewrite one number."}'></div>
...
"1.4": `<div class="wrap">
  ...
  <div class="quiz" data-correct="1">
    ...
    <div class="qexp">Occasionally a genuinely better algorithm exists and you should look once. But a request with no currency attached is not a technical problem, it is an unmade decision, and returning it as a question is the useful move. Caching hides the answer rather than giving it: it spends both memory and freshness.</div>
  </div>
...
<div class="reel" data-reel='{"title":"How a computer holds a thing, in one continuous run","speed":1500,"caption":"Eleven acts, about 2 minutes end to end. Part 2 shows the mechanisms. Part 3 runs those exact same mechanisms inside a photo, an undo button, a database index and a chat app that freezes. Nothing here needs code.","acts":[{"part":"Part 1 · The idea","tab":"Boxes and labels","title":"Act 1 · There is only one thing underneath everything","type":"reveal","speed":1650,"viz":{"maxChars":16,"gy":48,"nodes":[{"id":"m","label":"Memory: numbered boxes, all the same size, in order","col":1,"row":0,"kind":"dark"},{"id":"n","label":"The name you wrote","col":0,"row":1,"kind":"gold"},{"id":"a","label":"A box number","col":1,"row":1,"kind":"accent"},{"id":"v","label":"A value sitting in it","col":2,"row":1,"kind":"accent"},{"id":"d","label":"A data structure: how you lay things down in those boxes","col":1,"row":2,"kind":"dark"}],"edges":[{"from":"m","to":"a"},{"from":"n","to":"a","label":"is only a label for"},{"from":"a","to":"v","label":"which holds","style":"green"},{"from":"a","to":"d","style":"green"}]},"steps":[{"show":["m"],"look":["m"],"say":"Everything starts here. A very long row of numbered boxes, all the same size, sitting in order. That is memory, and there is nothing else."},{"show":["m","n","a"],"look":["n"],"say":"The names you write are for you. <b>They are gone by the time the program runs.</b> What survives is a number."},{"show":["m","n","a","v"],"found":["v"],"say":"That number is the box, and the box holds the value. A computer does not know what anything is. It only knows where things are."},{"show":["m","n","a","v","d"],"found":["d"],"say":"<b>And a data structure is nothing more than a decision about how you lay things down in those boxes.</b> Every cost in the next eighteen chapters follows from that one decision."}]},{"part":"Part 2 · The mechanisms","tab":"Position is arithmetic","title":"Act 2 · Reaching the third thing without counting to three","type":"array-scan","speed":1500,"big":true,"data":[42,17,88,5,63,91,30,74],"labels":["1040","1044","1048","1052","1056","1060","1064","1068"],"countLabel":" calculation","legend":[["being reached","look"],["already placed","seen"],["landed on it","found"]],"steps":[{"look":[0],"ptr":{"i":0},"count":1,"say":"Eight numbers, back to back. The first lives in box 1040, and every box is four wide."},{"look":[1],"seen":[0],"ptr":{"i":1},"count":1,"say":"Where do those labels come from? Four wide, so the second box is 1044 and every label after it is the one before plus four. <b>The whole row of addresses was fixed by the layout, before a single value was stored.</b>"},{"look":[2],"seen":[0,1],"ptr":{"i":2},"count":1,"say":"Give me the third one. A person counts along. A computer does not."},{"found":[2],"seen":[0,1],"ptr":{"i":2},"count":1,"say":"1040, plus 2, times 4, equals 1048. <b>One calculation. No counting, no walking, no searching.</b>"},{"found":[6],"ptr":{"i":6},"count":1,"say":"The seventh? Still one calculation. <b>The seven millionth would also be one calculation.</b> This is the first operation in the course that does not care how much data you have, and there are not many of them."},{"seen":[0,1,2,3,4,5,6,7],"count":1,"say":"All of this rests on one condition: <b>every box exactly the same width</b>. Sentences are not the same width, so a row of sentences holds their addresses instead, and that workaround is what Act 5 opens up."}]},{"part":"Part 2 · The mechanisms","tab":"Reach: row versus chain","title":"Act 3 · Two arrangements, asked to reach the sixth thing","type":"race","speed":1200,"legend":[["working now","look"],["already walked","seen"],["arrived","found"]],"tracks":[{"label":"Together","data":["A","B","C","D","E","F","G","H"]},{"label":"Linked","data":["A","B","C","D","E","F","G","H"]}],"steps":[{"say":"Same eight things, stored two different ways. Reach the sixth one.","lanes":[{"look":[5],"count":1},{"look":[0],"count":1}]},{"say":"The block calculated an address and landed, never touching the five before it. The chain has no address to calculate, so it walks.","lanes":[{"found":[5],"count":1},{"look":[2],"seen":[0,1],"count":3}]},{"say":"The chain cannot skip. <b>Each node holds exactly one fact about location, which is where the next one is</b>, so there is nothing to jump with.","lanes":[{"found":[5],"count":1},{"look":[3],"seen":[0,1,2],"count":4}]},{"say":"Every hop here is one more read, and not one of them can be worked out in advance. <b>Together is not only fewer steps, it is also the arrangement a machine reads fastest.</b>","lanes":[{"found":[5],"count":1},{"look":[4],"seen":[0,1,2,3],"count":5}]},{"say":"<b>Six steps against one.</b> At a million items it is a million against one, and that gap is not going to close.","lanes":[{"found":[5],"count":1},{"found":[5],"seen":[0,1,2,3,4],"count":6}]}]},{"part":"Part 2 · The mechanisms","tab":"Insert: the verdict flips","title":"Act 4 · Same two arrangements, one different job","type":"race","speed":1600,"legend":[["must move","seen"],["being edited","look"],["done","found"]],"tracks":[{"label":"Together","data":["A","B","C","D","E","F","G","H"],"countLabel":" moves"},{"label":"Linked","data":["A","B","C","D","E","F","G","H"],"countLabel":" edits"}],"steps":[{"say":"Nothing has changed except the question. Now insert something at the very front.","lanes":[{"look":[0],"count":0},{"look":[0],"count":0}]},{"say":"Watch the order of the copies. <b>The last item moves first</b>, because moving A first would land on top of B before B had gone anywhere. Meanwhile the chain writes its one new node.","lanes":[{"look":[0],"seen":[7],"count":1},{"look":[0],"count":1}]},{"say":"Four copies in, and the new item has still not been written. The chain has already finished: <b>its two edits did not depend on how many items were sitting in front.</b>","lanes":[{"look":[0],"seen":[4,5,6,7],"count":4},{"found":[0],"count":2}]},{"say":"The block has no gap and cannot make one from nothing, so <b>every item shifts right</b>. The chain writes one node and changes one address.","lanes":[{"seen":[0,1,2,3,4,5,6,7],"count":8},{"found":[0],"count":2}]},{"say":"<b>Eight moves against two edits. The winner reversed, and neither structure changed.</b> Only the job did. That is the trade that never goes away.","lanes":[{"found":[0],"seen":[1,2,3,4,5,6,7],"count":8},{"found":[0],"count":2}]}]},{"part":"Part 2 · The mechanisms","tab":"What a link is","title":"Act 5 · A pointer is not magic, it is a number","type":"reveal","speed":1600,"viz":{"maxChars":16,"gy":48,"nodes":[{"id":"n","label":"One node","col":0,"row":0,"kind":"dark"},{"id":"v","label":"The value: 42","col":1,"row":0,"kind":"accent"},{"id":"p","label":"A box number: 2096","col":1,"row":1,"kind":"gold"},{"id":"x","label":"another node, somewhere completely unrelated","col":2,"row":1,"kind":"muted"}],"edges":[{"from":"n","to":"v","label":"holds"},{"from":"n","to":"p","label":"and holds"},{"from":"p","to":"x","label":"follow it","style":"gold"}]},"steps":[{"show":["n"],"look":["n"],"say":"Open one link of the chain from Act 3 and there are exactly two things inside it."},{"show":["n","v"],"found":["v"],"say":"The value. Obvious."},{"show":["n","v","p"],"look":["p"],"say":"And a second box holding <b>a number</b>. Not a connection, not a relationship. Just a number, that happens to be the number of another box."},{"show":["n","v","p","x"],"look":["p","x"],"say":"Follow that number and you land on another node, sitting somewhere completely unrelated. <b>Nothing is next to anything, so the order lives in the numbers rather than in the layout.</b>"},{"show":["n","v","p","x"],"look":["p"],"say":"That is also what it costs: <b>every item now carries an extra box it did not need</b>. A million linked items carry a million addresses, and at eight bytes each that is eight megabytes of pure bookkeeping."},{"show":["n","v","p","x"],"found":["x"],"say":"<b>That one move is the whole basis of Chapters 9 to 13.</b> Trees, graphs, file systems, the page you are reading. All of it is boxes holding the numbers of other boxes."}]},{"part":"Part 2 · The mechanisms","tab":"The three promises","title":"Act 6 · What separates an algorithm from a hope","type":"reveal","speed":1600,"viz":{"maxChars":16,"gy":48,"nodes":[{"id":"r","label":"A list of steps","col":1,"row":0,"kind":"dark"},{"id":"f","label":"Does it always finish?","col":0,"row":1,"kind":"gold","shape":"diamond"},{"id":"c","label":"Is it correct on every input?","col":1,"row":1,"kind":"gold","shape":"diamond"},{"id":"d","label":"Same input, same answer?","col":2,"row":1,"kind":"gold","shape":"diamond"},{"id":"ok","label":"An algorithm","col":1,"row":2,"kind":"accent"},{"id":"no","label":"A procedure that works until it does not","col":3,"row":2,"kind":"bad"}],"edges":[{"from":"r","to":"f"},{"from":"r","to":"c"},{"from":"r","to":"d"},{"from":"f","to":"ok","label":"yes","style":"green"},{"from":"c","to":"ok","label":"yes","style":"green"},{"from":"d","to":"ok","label":"yes","style":"green"},{"from":"d","to":"no","label":"no"}]},"steps":[{"show":["r"],"look":["r"],"say":"Steps alone are not an algorithm. Three questions decide it."},{"show":["r","f"],"look":["f"],"say":"<b>Does it always finish?</b> Not usually. Always."},{"show":["r","f","c"],"look":["c"],"say":"<b>Is it correct on every input?</b> Including the empty one, the enormous one, and the strange one nobody tried."},{"show":["r","f","c","d"],"look":["d"],"say":"<b>Same input, same answer?</b> If not, you cannot test it and you cannot trust it."},{"show":["r","f","c","d","ok"],"found":["ok"],"say":"Three yeses, and only then does it earn the word."},{"show":["r","f","c","d","ok","no"],"found":["ok"],"look":["no"],"say":"<b>One no, and this is what you shipped.</b> It looks identical in a demo. The difference appears later, on somebody else."},{"show":["r","f","c","d","ok","no"],"look":["f","no"],"say":"Promise one, broken, looks like a payment that retries until it succeeds, with no maximum attempts and no giving up. <b>Every step in it is reasonable, and nothing in it guarantees an ending.</b>"},{"show":["r","f","c","d","ok","no"],"look":["d","no"],"say":"Promise three, broken, looks like a revenue report run twice over the same date range that lands on totals a few paise apart. Nothing was miscalculated: <b>the amounts were simply added in whatever order they arrived.</b>"},{"show":["r","f","c","d","ok","no"],"found":["ok"],"bad":["no"],"say":"Neither of those is caught by testing, because both of them worked every time anybody watched. <b>A demo proves it worked once, on one input, in one moment</b>, and that is not one of the three."}]},{"part":"Part 3 · The same ideas, in things you used today","tab":"A photo","title":"Act 7 · A photo is Act 2 with a much longer row","type":"array-scan","speed":1500,"big":true,"data":[18,42,240,255,120,64,90,200],"labels":["r0","g0","b0","r1","g1","b1","r2","g2"],"countLabel":" calculation","legend":[["being reached","look"],["must move","seen"],["landed on it","found"]],"steps":[{"look":[0],"count":1,"say":"Your phone does not hold a photo as a photo. The moment it opens one, it holds <b>one very long row of numbers</b>, three per pixel, and something else agrees to read that row as an image."},{"look":[0],"ptr":{"i":0},"count":1,"badge":"36,578,304 numbers","say":"Eight boxes here. A twelve megapixel photo is 4032 across and 3024 down, which is <b>36,578,304 numbers in one unbroken run</b>, and not one of them knows it is part of a picture."},{"found":[4],"ptr":{"i":4},"count":1,"say":"Want the pixel at row 200, column 640? Width times 200, plus 640, times 3. <b>One calculation.</b> This is Act 2, unchanged, with a row a few million boxes long."},{"found":[4],"ptr":{"i":4},"count":1,"badge":"box 2,421,120","say":"Put the real numbers in: row 200 times 4032, plus column 640, all times 3, is <b>box 2,421,120</b>. Two multiplications and one addition, and the other 36 million boxes were never consulted."},{"found":[4],"ptr":{"i":4},"count":1,"say":"Which is why cropping is cheap: you are just reading a different stretch of the same row."},{"look":[4,5,6,7],"count":1,"say":"Crop the top off and you read one unbroken stretch. Crop the sides and you read 3024 short runs instead, one per line: <b>same picture, and the shape of the read changed completely.</b>"},{"seen":[3,4,5,6,7],"say":"<b>And why inserting a row of pixels into the middle is not.</b> Open a gap at r1 and every box after it has to move, which is five boxes here and millions in the real photo. Act 4, unchanged. Same arrangement, same bill."}]},{"part":"Part 3 · The same ideas, in things you used today","tab":"Undo","title":"Act 8 · Undo is Act 3, and it is linked on purpose","type":"graph-walk","speed":1400,"unit":118,"legend":[["where you are now","look"],["already undone","seen"],["arrived","found"]],"nodes":[{"id":"e1","label":"type","x":0,"y":0},{"id":"e2","label":"bold","x":1,"y":0},{"id":"e3","label":"paste","x":2,"y":0},{"id":"e4","label":"delete","x":3,"y":0},{"id":"e5","label":"type","x":4,"y":0}],"edges":[{"from":"e1","to":"e2"},{"from":"e2","to":"e3"},{"from":"e3","to":"e4"},{"from":"e4","to":"e5"}],"steps":[{"look":["e5"],"say":"Every edit you make in any editor is one node that knows the edit before it. A chain, exactly as in Act 3."},{"look":["e4"],"seen":["e5"],"say":"Press undo. Follow one address backwards. <b>Nothing moved and nothing was copied.</b>"},{"look":["e3"],"seen":["e4","e5"],"say":"Again. Adding a new edit is two edits to the chain, which is Act 4 with the winner on the other side."},{"found":["e2"],"seen":["e3","e4","e5"],"say":"<b>And nobody has ever asked for the 40,000th undo by position.</b> The slow operation of a chain is the one this feature never performs, which is exactly why it is the right arrangement."},{"look":["e2"],"seen":["e3","e4","e5"],"edges":["e1-e2","e2-e3","e3-e4","e4-e5"],"tags":{"e2":"here"},"say":"The editor never counts through forty thousand edits to find your place. <b>It holds one address, which is where you are now</b>, and moving that address costs the same on the fourth edit or the forty thousandth."},{"look":["e2"],"seen":["e3","e4","e5"],"edges":["e1-e2"],"say":"Now type one new character here. <b>Paste, delete and type stop being reachable the moment one address is overwritten</b>, and that is exactly why redo disappears after you type."}]},{"part":"Part 3 · The same ideas, in things you used today","tab":"Adding an index","title":"Act 9 · The full invoice nobody reads","type":"reveal","speed":1650,"viz":{"maxChars":15,"gy":46,"nodes":[{"id":"p","label":"Finding one row takes 4 seconds","col":0,"row":1,"kind":"bad"},{"id":"i","label":"Add a search index","col":1,"row":1,"kind":"gold"},{"id":"g","label":"Reads: 4 seconds becomes 9 milliseconds","col":2,"row":0,"kind":"accent"},{"id":"w","label":"Writes: every insert now also updates the index","col":2,"row":1,"kind":"bad"},{"id":"s","label":"Storage: up by a quarter","col":2,"row":2,"kind":"bad"},{"id":"r","label":"Bulk imports: minutes instead of seconds","col":3,"row":2,"kind":"bad"}],"edges":[{"from":"p","to":"i"},{"from":"i","to":"g","label":"what you bought","style":"green"},{"from":"i","to":"w","label":"what you paid"},{"from":"i","to":"s","label":"what you paid"},{"from":"s","to":"r"}]},"steps":[{"show":["p"],"look":["p"],"say":"A real and ordinary complaint. Finding one row takes four seconds, and it gets worse every month."},{"show":["p","i"],"look":["i"],"say":"So the team adds an index, which is Act 5 kept on disk: order maintained as a shape."},{"show":["p","i","g"],"found":["g"],"say":"<b>And it works.</b> Four seconds becomes nine milliseconds. This is the line that goes in the update."},{"show":["p","i","g","w"],"look":["w"],"say":"Here is the rest of the invoice. Every insert now also updates the index, so writes got slower."},{"show":["p","i","g","w","s"],"look":["s"],"say":"Storage went up, because the index is a second copy of the order."},{"show":["p","i","g","w","s","r"],"look":["r"],"say":"<b>And the nightly import went from eight minutes to fifty.</b> Nothing regressed. The bill simply arrived on an operation nobody was watching."},{"show":["p","i","g","w","s","r"],"found":["g"],"look":["r"],"say":"So do you roll the index back? No, because <b>the index is doing exactly what it was bought to do</b> and the reads it bought are still worth having."},{"show":["p","i","g","w","s","r"],"found":["g","i"],"say":"The fix is to move when the bill is paid: drop the index, run the import, then rebuild it once at the end. <b>Almost every good performance fix has that shape, not removing a cost but moving it to a moment when nobody is waiting.</b>"}]},{"part":"Part 3 · The same ideas, in things you used today","tab":"When you pick wrong","title":"Act 10 · The chat that freezes, and why it is not a rendering bug","type":"race","speed":1600,"legend":[["must move","seen"],["being edited","look"],["done","found"]],"tracks":[{"label":"Messages in a row","data":["A","B","C","D","E","F","G","H"]},{"label":"Messages linked","data":["A","B","C","D","E","F","G","H"]}],"steps":[{"say":"A group chat with 40,000 messages freezes for half a second every time a new one arrives. Small groups are fine. The message itself is tiny.","lanes":[{"look":[0],"count":0},{"look":[0],"count":0}]},{"say":"New messages go to the front. The messages are stored together. <b>So every single arrival shifts 40,000 items right by one.</b>","lanes":[{"seen":[0,1,2,3,4,5,6,7],"count":8},{"look":[0],"count":1}]},{"say":"<b>This is Act 4, in a product.</b> Linked, the same arrival is two edits, at forty thousand messages or at four million.","lanes":[{"seen":[0,1,2,3,4,5,6,7],"count":8},{"found":[0],"count":2}]},{"say":"<b>The most frequent operation in the product was the one the chosen arrangement is worst at.</b> Not a rendering bug, not the network. An arrangement chosen before anyone knew what the app would spend its day doing.","lanes":[{"found":[0],"seen":[1,2,3,4,5,6,7],"count":8},{"found":[0],"count":2}]},{"say":"Nobody caught this in testing. On a twenty message group the very same shift is a handful of moves and finishes before anybody can see it, so <b>the arrangement was wrong from day one and only forty thousand messages made it visible.</b>","lanes":[{"look":[0],"seen":[1,2,3],"count":4},{"found":[0],"count":2}]},{"say":"And the fix is not always a rewrite: <b>keep the row, append to the end, and display it reversed.</b> A new message added after everything means nothing in front of it has to move.","lanes":[{"found":[7],"count":1},{"found":[0],"count":2}]}]},{"part":"Part 4 · The map","tab":"The map","title":"Act 11 · The whole chapter, on one page","type":"reveal","speed":1700,"viz":{"maxChars":16,"gy":48,"nodes":[{"id":"s","label":"Many things to store","col":2,"row":0,"kind":"dark"},{"id":"q1","label":"Read by position, or rearrange constantly?","col":2,"row":1,"kind":"gold","shape":"diamond"},{"id":"tog","label":"Together: a row. Position is arithmetic","col":0,"row":2,"kind":"accent"},{"id":"lnk","label":"Linked: a chain. Rewiring is two edits","col":4,"row":2,"kind":"gold"},{"id":"q2","label":"Do the steps make all three promises?","col":2,"row":2,"kind":"gold","shape":"diamond"},{"id":"pr","label":"Finishes, correct, repeatable","col":2,"row":3,"kind":"accent"},{"id":"cur","label":"Now name the currency you spent: time, space or order","col":2,"row":4,"kind":"dark"}],"edges":[{"from":"s","to":"q1"},{"from":"q1","to":"tog","label":"read"},{"from":"q1","to":"lnk","label":"rearrange","style":"gold"},{"from":"tog","to":"q2","style":"green"},{"from":"lnk","to":"q2","style":"green"},{"from":"q2","to":"pr","label":"all three yes","style":"green"},{"from":"pr","to":"cur","style":"green"}]},"steps":[{"show":["s"],"look":["s"],"say":"Eleven acts collapse into three decisions."},{"show":["s","q1"],"look":["q1"],"say":"<b>Decision one.</b> Will you mostly read by position, or mostly rearrange? There is no third option and there never will be."},{"show":["s","q1","tog"],"found":["tog"],"say":"Read: keep it together. Acts 2, 3 and 7. Position becomes arithmetic, and rearranging becomes expensive."},{"show":["s","q1","tog","lnk"],"found":["lnk"],"say":"Rearrange: link it. Acts 4, 5 and 8. Rewiring becomes two edits, and reaching becomes a walk."},{"show":["s","q1","tog","lnk","q2"],"look":["q2"],"say":"<b>Decision two.</b> Whatever steps you then run over it: do they finish, are they correct, are they repeatable?"},{"show":["s","q1","tog","lnk","q2","pr"],"found":["pr"],"say":"Three yeses, from Act 6. One no and you have shipped something that only looks like it works."},{"show":["s","q1","tog","lnk","q2","pr","cur"],"found":["cur"],"say":"<b>Decision three, and the one people skip.</b> Name the currency. Act 9 is what happens when you buy without reading the invoice, and Act 10 is what happens when you never ask the first question at all."},{"show":["s","q1","tog","lnk","q2","pr","cur"],"look":["cur"],"say":"And order is the currency people skip. Time is paid per operation and space is paid once, but <b>a promise to stay tidy is re-paid on every write for the life of the system</b>, which is why Act 9 felt free in week one."},{"show":["s","q1","tog","lnk","q2","pr","cur"],"say":"<b>Every structure is fast at something because it agreed to be slow at something else.</b> That sentence is the chapter, and it does not stop being true in any of the eighteen chapters after this one."}]}]}'></div>
