...
"8.2": `<div class="wrap">
  ...
  <div class="board" data-anim='{"type":"graph-walk","title":"The other answer: box 0 holds a chain","speed":1600,"directed":true,"unit":124,"legend":[["the box you computed","look"],["walking the chain","seen"],["found it","found"]],"nodes":[{"id":"b0","label":"0","x":0,"y":0},{"id":"b1","label":"1","x":1,"y":0},{"id":"b5","label":"5","x":2,"y":0},{"id":"b7","label":"7","x":3,"y":0},{"id":"ana","label":"ana","x":0,"y":1},{"id":"leo","label":"leo","x":0,"y":2},{"id":"sam","label":"sam","x":1,"y":1},{"id":"raj","label":"raj","x":2,"y":1},{"id":"mia","label":"mia","x":3,"y":1}],"edges":[{"from":"b0","to":"ana"},{"from":"ana","to":"leo"},{"from":"b1","to":"sam"},{"from":"b5","to":"raj"},{"from":"b7","to":"mia"}],"steps":[{"edges":["b0-ana","ana-leo","b1-sam","b5-raj","b7-mia"],"say":"The same four boxes, and box 0 now holds <b>a chain of two</b> rather than one name. Nothing was moved and nothing walked to a different box."},{"edges":["b0-ana","ana-leo","b1-sam","b5-raj","b7-mia"],"look":["b0"],"say":"Reading leo: compute 32, take the remainder, get box 0. <b>One step to the box, exactly as in Lesson 8.1.</b>"},{"edges":["b0-ana","ana-leo","b1-sam","b5-raj","b7-mia"],"seen":["b0","ana"],"look":["leo"],"say":"Then walk the chain: ana is not leo, so follow to the next one. <b>That walk is Lesson 4.1, and it costs one hop per name in the box.</b>"},{"edges":["b0-ana","ana-leo","b1-sam","b5-raj","b7-mia"],"seen":["b0","ana"],"found":["leo"],"say":"Found. <b>One step plus one hop.</b> And the important part: sam, raj and mia are untouched, so their lookups are still exactly one step. The cost of a collision stayed inside the box it happened in."}],"caption":"This is the difference between the two strategies in one picture. Walking to the next free box spreads the cost of a collision into boxes that had nothing to do with it. Keeping a chain confines the cost to the box where the clash actually happened."}'></div>

  <div class="viz" data-viz='{"type":"seq","title":"What the box actually hands back","actors":[{"label":"You, asking for leo","kind":"gold"},{"label":"Box 0","kind":"accent"},{"label":"The chain inside it","kind":"muted"}],"messages":[{"from":0,"to":1,"label":"32 leaves nothing, so I want box 0","style":"gold"},{"from":1,"to":0,"label":"not a name. The start of a chain"},{"from":0,"to":2,"label":"so I must ask. Are you leo"},{"from":2,"to":0,"label":"no, I am ana. Next is one hop on"},{"from":0,"to":2,"label":"one hop. Are you leo","style":"gold"},{"from":2,"to":0,"label":"yes. And no other box was asked","style":"green"}],"caption":"The box does not hold leo and it never did. It hands back where a chain starts, so the arithmetic narrows you to one box and a comparison is what finally settles which name is which. Lesson 8.1 never compared anything at all, and this is where comparing comes back: one hop per name in the box, with a comparison at every stop. Chaining keeps those comparisons inside the box that clashed rather than pushing them onto boxes that had nothing to do with it, and it pays for that with a chain node on every entry."}'></div>
...
<div class="reel" data-reel='{"title":"An answer without a search, and what it costs","speed":1600,"caption":"Thirteen acts, about 2 minutes end to end. Part 2 builds the whole machine on real arithmetic you can check by hand. Part 3 runs it inside a table somebody shrank to save memory, a payment charged twice, and a cache that made everything slower.","acts":[{"part":"Part 1 · The idea","tab":"Compute, do not look","title":"Act 1 · The address was never unknown","type":"reveal","speed":1650,"viz":{"maxChars":16,"gy":42,"nodes":[{"id":"q","label":"Where is it?","col":0,"row":1,"kind":"dark"},{"id":"l","label":"Look for it: scan, halve, walk a shape","col":1,"row":0,"kind":"accent"},{"id":"c","label":"Compute it: arithmetic on the key itself","col":1,"row":2,"kind":"gold"},{"id":"lr","label":"Cost grows with how much you have","col":2,"row":0,"kind":"accent"},{"id":"cr","label":"Cost never mentions how much you have","col":2,"row":2,"kind":"gold"},{"id":"cd","label":"And it answers one exact key, and nothing else","col":2,"row":3,"kind":"bad"}],"edges":[{"from":"q","to":"l"},{"from":"q","to":"c"},{"from":"l","to":"lr"},{"from":"c","to":"cr"},{"from":"c","to":"cd"}]},"steps":[{"show":["q"],"look":["q"],"say":"Every structure in this course answers one question, and there are only two ways to do it."},{"show":["q","l","lr"],"found":["l"],"seen":["lr"],"say":"Chapters 6 and 7 looked: scanning, halving, walking a shape. <b>Every one of them costs more as the pile grows.</b>"},{"show":["q","l","lr","c","cr"],"found":["l","c"],"seen":["lr","cr"],"say":"This chapter computes. <b>The cost does not mention the pile at all</b>, which no other structure here manages."},{"show":["q","l","lr","c","cr","cd"],"found":["c"],"seen":["lr","cr"],"bad":["cd"],"say":"And the counterweight arrives in the same breath. <b>The address comes from one exact key</b>, so ranges, order and nearest all go at once."}]},{"part":"Part 2 · The methods","tab":"One step","title":"Act 2 · Four names, and the counter never moves","type":"array-scan","speed":1500,"big":true,"data":["ana","raj","sam","mia"],"capacity":8,"countLabel":" looks","pointerLabels":{"i":"computing"},"legend":[["being placed","look"],["stored","found"],["read back in one step","seen"]],"steps":[{"capacity":8,"order":[null,null,null,null,null,null,null,null],"count":0,"say":"Eight boxes, numbered 0 to 7. The rule: <b>add up the letters, take the remainder on eight.</b>"},{"capacity":8,"order":[0,null,null,null,null,null,null,null],"look":[0],"ptr":{"i":0},"count":0,"say":"<b>ana.</b> a is 1, n is 14, a is 1, so 16, and sixteen divided by eight leaves nothing. Box 0. <b>Work raj out yourself before the next frame</b>, because the address is not a secret, it is arithmetic you can do."},{"capacity":8,"order":[0,null,null,null,null,1,null,null],"found":[0],"look":[1],"ptr":{"i":5},"count":0,"say":"ana is 16, which leaves nothing, so box 0. raj is 29, which leaves 5. <b>No box was examined to decide either.</b>"},{"capacity":8,"order":[0,2,null,null,null,1,null,3],"found":[0,2,1,3],"ptr":{"i":7},"count":0,"badge":"4 stored, 0 looks","say":"sam to box 1, mia to box 7. <b>Four names stored and the counter is still zero.</b>"},{"capacity":8,"order":[0,2,null,null,null,1,null,3],"seen":[2],"found":[0,1,3],"ptr":{"i":1},"count":1,"badge":"is sam here? 1 look","say":"Is sam here? Compute, get 1, look in box 1. <b>One look.</b> Lesson 6.2 needed about 95,000 to answer the same shape of question."},{"capacity":8,"order":[0,2,null,null,null,1,null,3],"found":[0,2,1,3],"ptr":{"i":3},"count":1,"badge":"is bob here? 1 look","say":"And bob? 2 plus 15 plus 2 is 19, which leaves 3. <b>Box 3 is empty, so the answer is no, in one look.</b> In Lesson 6.2 a no was the expensive answer, the one that had to read all hundred thousand. Here a no and a yes cost the same."},{"capacity":8,"order":[0,2,null,null,null,1,null,3],"found":[0,2,1,3],"count":1,"badge":"no index, no order","say":"Now notice what is not on this board. <b>Nothing ever recorded where anything went.</b> Reading sam ran the same arithmetic again, which is why this table needs no index and no order, and why Act 5 is going to hurt."}]},{"part":"Part 2 · The methods","tab":"The clash","title":"Act 3 · leo wants a box that is taken","type":"array-scan","speed":1500,"big":true,"data":["ana","raj","sam","mia","leo"],"capacity":8,"countLabel":" boxes touched","pointerLabels":{"i":"probing"},"legend":[["stored","found"],["occupied, keep walking","bad"],["where it settled","seen"]],"steps":[{"capacity":8,"order":[0,2,null,null,null,1,null,3],"found":[0,2,1,3],"count":0,"badge":"4 names, 8 boxes","say":"Before leo arrives, count the odds. Four names dropped into eight boxes, and <b>the chance that some two of them wanted one box was already about 59 percent.</b> These four got away with it. That is luck, not design."},{"capacity":8,"order":[0,2,null,null,null,1,null,3],"found":[2,1,3],"bad":[0],"ptr":{"i":0},"count":1,"say":"leo is 32, which leaves nothing, so <b>box 0. And ana is in it.</b> Nothing went wrong: two names computed to one address."},{"capacity":8,"order":[0,2,null,null,null,1,null,3],"found":[1,3],"bad":[0,2],"ptr":{"i":1},"count":2,"say":"One answer is to walk. Box 0 taken, box 1 taken. <b>The counter is moving, and in Act 2 it never did.</b>"},{"capacity":8,"order":[0,2,4,null,null,1,null,3],"found":[0,2,1,3],"seen":[4],"ptr":{"i":2},"count":3,"badge":"ana 1, sam 1, leo 3","say":"Box 2 is free, so leo lives there. <b>Three boxes touched, and the cost stopped being a property of leo alone.</b>"},{"capacity":8,"order":[0,2,4,null,null,1,null,3],"found":[1,3],"bad":[0,2],"seen":[4],"ptr":{"i":2},"count":3,"badge":"reading leo: 3 boxes","say":"And reading leo costs the same three, every time. Compute 0, find ana, walk to 1, find sam, then 2. <b>The write paid three once and every read pays three for as long as leo is in the table.</b>"},{"capacity":8,"order":[0,2,4,null,null,1,null,3],"found":[0,2,1,3],"seen":[4],"count":3,"badge":"box 2 belonged to nobody","say":"And box 2 never belonged to leo. <b>Any name that computes to 2 from now on has to walk past leo first</b>, so storing one key made a different key slower, and nothing whatsoever changed about that key."}]},{"part":"Part 2 · The methods","tab":"The chain","title":"Act 4 · Or let the box hold two","type":"graph-walk","speed":1500,"directed":true,"unit":124,"legend":[["the box you computed","look"],["walking the chain","seen"],["found it","found"]],"nodes":[{"id":"b0","label":"0","x":0,"y":0},{"id":"b1","label":"1","x":1,"y":0},{"id":"b5","label":"5","x":2,"y":0},{"id":"b7","label":"7","x":3,"y":0},{"id":"ana","label":"ana","x":0,"y":1},{"id":"leo","label":"leo","x":0,"y":2},{"id":"sam","label":"sam","x":1,"y":1},{"id":"raj","label":"raj","x":2,"y":1},{"id":"mia","label":"mia","x":3,"y":1}],"edges":[{"from":"b0","to":"ana"},{"from":"ana","to":"leo"},{"from":"b1","to":"sam"},{"from":"b5","to":"raj"},{"from":"b7","to":"mia"}],"steps":[{"edges":["b0-ana","ana-leo","b1-sam","b5-raj","b7-mia"],"say":"The same clash, answered the other way. leo hangs under ana inside box 0, and <b>box 2 was never touched at all</b>, so it is still free for whoever computes to it. In Act 3 leo took it and kept it."},{"edges":["b0-ana","ana-leo","b1-sam","b5-raj","b7-mia"],"look":["b0"],"say":"The other answer: <b>box 0 holds a chain</b>, which is the structure Chapter 4 built. Reading leo: compute, get box 0, one step."},{"edges":["b0-ana","ana-leo","b1-sam","b5-raj","b7-mia"],"seen":["b0","ana"],"found":["leo"],"say":"Then walk. <b>One step plus one hop</b>, and sam, raj and mia are untouched. The cost of the clash stayed inside the box it happened in."},{"edges":["b0-ana","ana-leo","b1-sam","b5-raj","b7-mia"],"seen":["ana","sam","raj","mia","leo"],"say":"And here is what that safety costs. <b>Every entry now carries a link to the next one</b>, whether it ever clashes or not, so all five names pay Chapter 4 memory to protect the one box where two of them met."},{"edges":["b0-ana","ana-leo","b1-sam","b5-raj","b7-mia"],"look":["b0"],"seen":["ana"],"found":["leo"],"say":"A chain is also only cheap while it is short. <b>Ten names in one box is a ten hop walk</b>, and nothing stops a chain growing. Both strategies are fine while clashes are rare and both fall apart as the boxes crowd, which is why the real decision is neither of them. It is the next act."}]},{"part":"Part 2 · The methods","tab":"The resize","title":"Act 5 · Doubling re-scatters everything","type":"array-scan","speed":1700,"data":["ana","raj","sam","mia","kai"],"capacity":16,"countLabel":" boxes touched","pointerLabels":{"i":"arriving"},"legend":[["stored","found"],["a clash","bad"],["rehashed","seen"]],"steps":[{"capacity":8,"order":[0,2,null,null,null,1,null,3],"found":[0,2,1,3],"badge":"4 of 8: load 0.5","say":"Four names, eight boxes. <b>Load factor 0.5</b>, and lookups are one step because clashes are rare here."},{"capacity":8,"order":[0,2,null,null,null,1,null,3],"found":[0,2,3],"bad":[1],"ptr":{"i":5},"badge":"5 of 8: load 0.63","say":"kai is 21, which leaves 5, and raj is there. <b>That crosses the line.</b>"},{"capacity":16,"order":[0,2,null,null,null,1,null,3],"found":[0,2,1,3],"badge":"double to 16","say":"So the table doubles. <b>This is Lesson 3.3, with a different trigger:</b> a row grows when full, this grows when half full."},{"capacity":16,"order":[null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],"badge":"the rebuild starts empty","say":"And the doubling does not slide anything sideways. <b>The rebuild starts from an empty table</b>, because the address is computed from the number of boxes, so not one of the five addresses can be trusted the instant that number changes."},{"capacity":16,"order":[0,2,null,null,null,4,null,3,null,null,null,null,null,1,null,null],"seen":[0,2,3,1],"found":[4],"badge":"every lookup: 1 step","say":"And every address is recomputed, because none were ever written down. raj leaves 5 on eight and 13 on sixteen. <b>The clash is gone. Doubling re-scattered the keys.</b>"},{"capacity":16,"order":[0,2,null,null,null,4,null,3,null,null,null,null,null,1,null,null],"found":[0,2,4,3,1],"badge":"5 keys, 5 fresh insertions","say":"Count what the move cost. <b>Five keys, five fresh insertions</b>, to make room for one new name. This is why a resize is a rebuild and not an extension."},{"capacity":16,"order":[0,2,null,null,null,4,null,3,null,null,null,null,null,1,null,null],"found":[0,2,4,3,1],"badge":"about 1 copy per insertion","say":"And growing to a thousand items doubles about ten times and copies about a thousand items in total, so it averages <b>about one copy per insertion.</b> Lesson 3.3 did this arithmetic already. One unlucky insertion is very expensive and the average is still cheap, and both of those are true at once."}]},{"part":"Part 2 · The methods","tab":"Dedup","title":"Act 6 · Nine ids, four repeats, zero comparisons","type":"array-scan","speed":1500,"big":true,"data":[41,17,41,63,17,88,41,63,25],"countLabel":" comparisons","pointerLabels":{"i":"asking"},"legend":[["being asked","look"],["new: kept","found"],["a repeat: dropped","bad"]],"steps":[{"order":[0,1,2,3,4,5,6,7,8],"look":[0],"ptr":{"i":0},"count":0,"say":"Nine order ids. For each one: compute its box and ask whether it is already there."},{"order":[0,1,2,3,4,5,6,7,8],"found":[0],"look":[1],"ptr":{"i":1},"count":0,"say":"17 next, and its box is empty, so it is new. <b>17 was never compared with 41.</b> The question was put to a box, not to the other ids, and that is why a comparison counter can sit here at zero."},{"order":[0,1,2,3,4,5,6,7,8],"found":[0,1,3,5],"bad":[2,4],"look":[6],"ptr":{"i":6},"count":0,"say":"41 arrives a third time, four ids later. <b>It costs exactly what it cost the first time.</b> A scan would have six earlier ids to check by now and would have seven by the next one. This asked one box, and it will still be one box at a million."},{"order":[0,1,2,3,4,5,6,7,8],"found":[0,1,3,5],"bad":[2,4,6],"count":0,"badge":"and the table is the bill","say":"The price is off the side of this picture. <b>A box is held for every distinct id while the pass runs</b>, kept about half empty, so a million distinct ids means a table of roughly two million boxes. Same purchase as Act 2, same invoice."},{"order":[0,1,2,3,4,5,6,7,8],"found":[0,1],"bad":[2],"look":[2],"ptr":{"i":2},"count":0,"say":"41 again. <b>Its box already holds 41, so it is a repeat</b>, discovered in one step without looking at any other id."},{"order":[0,1,2,3,4,5,6,7,8],"found":[0,1,3,5,8],"bad":[2,4,6,7],"count":0,"badge":"9 in, 5 kept, 0 comparisons","say":"<b>Nine in, five kept, and the comparison counter never moved.</b> Chapter 7 would have sorted, at about 20,000,000 comparisons for a million, and it would have destroyed the arrival order."}]},{"part":"Part 2 · The methods","tab":"The rule that clumps","title":"Act 7 · The rule that read the wrong part of the key","type":"array-scan","speed":1550,"big":true,"data":["ana","ali","ami","ash","raj","kim"],"capacity":8,"countLabel":" boxes touched","pointerLabels":{"i":"probing"},"legend":[["stored","found"],["occupied, keep walking","bad"],["where it settled","seen"]],"steps":[{"capacity":8,"order":[null,null,null,null,null,null,null,null],"count":0,"say":"Same eight boxes, six names, and a rule that sounds sensible: <b>use the first letter only.</b> a is 1, so box 1. It is cheap, it is consistent, and it obeys the one unbreakable requirement, which is that a key always gives the same box."},{"capacity":8,"order":[null,0,1,null,null,null,null,null],"bad":[0],"seen":[1],"ptr":{"i":2},"count":2,"say":"ana lands in box 1. ali is an a too, so it computes to box 1 as well, finds ana, and walks to 2. <b>The rule read the one letter these two share and threw away the two that differ.</b>"},{"capacity":8,"order":[null,0,1,2,3,null,null,null],"bad":[0,1,2],"seen":[3],"ptr":{"i":4},"count":4,"say":"ami walks three boxes, ash walks four. <b>Four names, four different letter totals, and one address between them.</b> This is not the Act 3 clash, where the arithmetic happened to agree. The rule aimed all four at the same box."},{"capacity":8,"order":[null,0,1,2,3,4,null,null],"found":[0],"bad":[1,2,3],"seen":[4],"ptr":{"i":5},"count":4,"say":"Now the strangers start paying. raj starts with r, which is 18, and leaves 2, and boxes 2, 3 and 4 are full of a-names it has nothing to do with. <b>raj walks four boxes for a clash that was never its own.</b>"},{"capacity":8,"order":[null,0,1,2,3,4,5,null],"found":[0,1],"bad":[2,3,4],"seen":[5],"ptr":{"i":6},"count":4,"say":"kim starts with k, which is 11, and leaves 3, and walks four as well. <b>Six names, and only the first one got the box it computed.</b> This is the slow region from Lesson 8.2: one shared key shape, one clump of boxes, and everybody who lands near it slows down too."},{"capacity":8,"order":[0,5,null,null,3,4,1,2],"found":[0,1,2,3,4,5],"count":1,"badge":"same names, same table","say":"Now add every letter instead. ana 16 leaves 0, kim 33 leaves 1, ash 28 leaves 4, raj 29 leaves 5, ali 22 leaves 6, ami 23 leaves 7. <b>Six names, six boxes, one step each.</b> The keys did not improve. The rule started reading the part that differs."},{"capacity":8,"order":[0,5,null,null,3,4,1,2],"found":[0,1,2,3,4,5],"count":1,"badge":"the third price","say":"This is the third price of the chapter, and the only one that arrives looking like a bug rather than a bill. <b>Structure in your keys that the rule fails to mix becomes structure in your boxes</b>, and you meet it as one region, one customer or one prefix being slow while everything else is instant."}]},{"part":"Part 3 · The same rules in things you used today","tab":"The wrong choice","title":"Act 8 · Somebody saved memory","type":"array-scan","speed":1600,"data":["ana","raj","sam","mia","kai","leo","zoe","ida"],"capacity":16,"countLabel":" boxes touched","legend":[["stored","found"],["had to walk to find a free box","bad"]],"steps":[{"capacity":16,"order":[0,2,null,null,null,4,null,3,null,null,null,null,null,1,null,null],"found":[0,2,4,3,1],"count":1,"badge":"5 of 16: 1 step","say":"<b>This is Act 5, working.</b> Five names, sixteen boxes, every lookup one step. And it uses about twice the memory of the data."},{"capacity":8,"order":[0,2,null,null,null,1,4,3],"found":[0,2,1,3],"bad":[4],"count":2,"badge":"5 records, 8 boxes","say":"Somebody noticed that and sized the table down to match the record count. <b>Memory dropped, and kai already had to walk one box to fit.</b>"},{"capacity":8,"order":[0,2,5,6,7,1,4,3],"found":[0,2,1,3],"bad":[4,5,6,7],"count":6,"badge":"8 of 8: load 1.0","say":"Three more arrive and the table is completely full. leo computes to box 0, finds ana, walks to 1, finds sam, and settles in 2. zoe computes to 6 and has to walk past five occupied boxes before it settles in 3. <b>Walking is no longer occasional, it is the normal path.</b> At 99 percent full, finding a free box walks about five thousand of them; at half it walked two."},{"capacity":8,"order":[0,2,5,6,7,1,4,3],"bad":[0,1,2,3,4,5,6,7],"count":8,"badge":"is a name that is not here in here?","say":"Now ask this table the Act 2 question: is a name that was never stored in here? <b>With no empty box anywhere, the walk has nothing to stop it</b>, so it touches all eight before it can say no. Lesson 6.2 is back, inside the structure that was bought to escape it."},{"capacity":8,"order":[0,2,5,6,7,1,4,3],"found":[6],"bad":[4,3,0,2,5],"count":6,"badge":"ana 1, zoe 6","say":"And the names that are here are no longer equal. Reading zoe means computing 6, then walking past kai, mia, ana, sam and leo before zoe appears in box 3. <b>ana is one box and zoe is six, on the same table with the same rule</b>, decided by nothing but arrival order."},{"capacity":8,"order":[0,2,5,6,7,1,4,3],"found":[0,1,2,3,4,5,6,7],"count":6,"badge":"saved 8 boxes, once","say":"So read the trade as it was actually made. <b>Eight boxes of memory saved, one time.</b> Six boxes touched to reach zoe, on every single read of zoe, for as long as the service runs. The saving was a number and the cost is a rate."},{"capacity":8,"order":[0,2,5,6,7,1,4,3],"found":[0,1,2,3],"bad":[4,5,6,7],"count":6,"badge":"the empty half WAS the speed","say":"<b>The empty half was not waste. It was the product.</b> Lesson 6.8 wrote it into the invoice as spare memory, permanently, in the same row that promised one step."}]},{"part":"Part 3 · The same rules in things you used today","tab":"This is Act 6, on a payment","title":"Act 9 · Charged twice, and nothing is broken","type":"reveal","speed":1600,"viz":{"maxChars":17,"gy":42,"nodes":[{"id":"s","label":"Send the charge","col":0,"row":1,"kind":"gold"},{"id":"t","label":"Provider is slow. The answer does not arrive","col":1,"row":1,"kind":"warn"},{"id":"r","label":"So retry. This is correct","col":2,"row":0,"kind":"accent"},{"id":"p","label":"Provider sees two distinct requests. Also correct","col":2,"row":2,"kind":"accent"},{"id":"c","label":"Customer charged twice","col":3,"row":1,"kind":"bad"},{"id":"f","label":"The fix: an id, and one question. Have I seen this?","col":4,"row":1,"kind":"gold"}],"edges":[{"from":"s","to":"t"},{"from":"t","to":"r"},{"from":"t","to":"p"},{"from":"r","to":"c"},{"from":"p","to":"c"},{"from":"c","to":"f"}]},"steps":[{"show":["s","t"],"look":["t"],"say":"A charge is sent and the provider is slow. <b>A timeout means the answer did not arrive, not that the work did not happen.</b>"},{"show":["s","t","r","p"],"found":["r","p"],"say":"So the sender retries, which is correct. And the provider processes a distinct request, which is also correct. <b>Neither side has a bug.</b>"},{"show":["s","t","r","p","c"],"found":["r","p"],"bad":["c"],"say":"And the customer is charged twice. Lesson 5.4 said it: <b>every abandoned request sent again is a new arrival.</b>"},{"show":["s","t","r","p","c","f"],"bad":["c"],"found":["f"],"say":"You cannot prevent the second request. <b>You make it harmless.</b> Send an id, and ask one question before acting, which is Act 6 with a different name."},{"show":["s","t","r","p","c","f"],"bad":["c"],"look":["f"],"say":"And the id has to be attached by the sender before the first attempt. <b>From the receiving side a retry and a genuine second purchase look identical</b>, so the only thing that can tell them apart is a name the work was given before it left."}]},{"part":"Part 3 · The same rules in things you used today","tab":"This is Act 2, in a cache","title":"Act 10 · The cache that made it slower","type":"race","speed":1600,"legend":[["work being done","look"],["answered","found"],["wasted","bad"]],"tracks":[{"label":"Miss: scanning the keys","data":[1,2,3,4,5,6,7,8],"countLabel":" ms before any work"},{"label":"Miss: computing the address","data":[1,2,3,4,5,6,7,8],"countLabel":" ms before any work"}],"steps":[{"badge":"hit rate 30 percent","lanes":[{"count":0},{"count":0}],"say":"A cache in front of a four second report. Hits are fast, the hit rate is thirty percent, <b>and the page got slower for everybody.</b>"},{"badge":"the 70 percent that miss","lanes":[{"look":[0,1,2,3,4,5],"count":"a scan"},{"look":[0],"count":"1 step"}],"say":"Everybody measures hits. <b>Nobody prices a miss</b>, and here seven requests in ten miss. On the left, finding that out means scanning the cached keys."},{"badge":"and the scan grows","lanes":[{"look":[0,1,2,3,4,5,6,7],"count":"a longer scan"},{"look":[0],"count":"1 step"}],"say":"And the left lane gets worse the more you cache. <b>Every entry added is one more key a miss has to walk past</b>, so that cache punishes its own growth. The right lane does not move, because the arithmetic never mentions how many keys are in there."},{"badge":"then they pay anyway","lanes":[{"bad":[0,1,2,3,4,5],"count":"scan + 4s"},{"found":[0],"count":"1 step + 4s"}],"say":"And then they pay the four seconds regardless. <b>The losing side of the bet paid twice.</b> This is Lesson 6.2 running inside a cache, one chapter later in a different costume."},{"badge":"the precondition, not the optimisation","lanes":[{"bad":[0,1,2,3,4,5,6,7],"count":"never worth it"},{"found":[0],"count":"1 step + 4s"}],"say":"So the fix is not a better hit rate. <b>It is Act 2: make the miss cost one step</b>, and the losing side of the bet pays only the four seconds it was always going to pay. A one step lookup is not an optimisation of a cache, it is the precondition for having one at all."}]},{"part":"Part 3 · The same rules in things you used today","tab":"This is Act 6, on a crawler","title":"Act 11 · The crawler that never stops","type":"reveal","speed":1600,"viz":{"maxChars":17,"gy":42,"nodes":[{"id":"s","label":"Start at one page","col":0,"row":1,"kind":"gold"},{"id":"f","label":"Follow every link it finds","col":1,"row":1,"kind":"accent"},{"id":"b","label":"Pages link back, so the same page arrives again","col":2,"row":1,"kind":"warn"},{"id":"l","label":"It works forever and never errors","col":3,"row":0,"kind":"bad"},{"id":"m","label":"Memory climbs until something stops it","col":3,"row":2,"kind":"bad"},{"id":"fix","label":"One question per page: have I seen this?","col":4,"row":1,"kind":"gold"}],"edges":[{"from":"s","to":"f"},{"from":"f","to":"b"},{"from":"b","to":"l"},{"from":"b","to":"m"},{"from":"l","to":"fix"},{"from":"m","to":"fix"}]},"steps":[{"show":["s","f"],"look":["f"],"say":"A crawler starts at one page and follows every link it finds. <b>Nothing about that is wrong.</b>"},{"show":["s","f","b"],"bad":["b"],"say":"But pages link back to each other, so <b>the same page arrives again, and again.</b> Links are not a tree."},{"show":["s","f","b","l","m"],"bad":["b","l","m"],"say":"It never errors, because nothing is failing. <b>It is doing real work on a page it already did.</b> Lesson 4.4: a walk with no memory cannot notice."},{"show":["s","f","b","l","m","fix"],"bad":["b"],"found":["fix"],"say":"<b>This is Act 6, on a crawler.</b> Keep a set of pages seen and ask one question per page. The memory grows with pages seen, and that is the price."}]},{"part":"Part 3 · The same rules in things you used today","tab":"One ordinary request","title":"Act 12 · Four computed addresses in one request","type":"reveal","speed":1600,"viz":{"maxChars":17,"gy":42,"nodes":[{"id":"r","label":"One ordinary request","col":0,"row":1,"kind":"gold"},{"id":"s","label":"Session token to user: one step","col":1,"row":0,"kind":"accent"},{"id":"i","label":"Have I done this request id before","col":1,"row":1,"kind":"accent"},{"id":"x","label":"Fetch the row by its exact id","col":1,"row":2,"kind":"accent"},{"id":"c","label":"Is this response already cached","col":1,"row":3,"kind":"accent"},{"id":"n","label":"Four one step answers, one request","col":2,"row":1,"kind":"gold"},{"id":"d","label":"Now show me everything from last March","col":3,"row":1,"kind":"bad"}],"edges":[{"from":"r","to":"s"},{"from":"r","to":"i"},{"from":"r","to":"x"},{"from":"r","to":"c"},{"from":"s","to":"n"},{"from":"i","to":"n"},{"from":"x","to":"n"},{"from":"c","to":"n"},{"from":"n","to":"d"}]},"steps":[{"show":["r"],"look":["r"],"say":"One ordinary request to one ordinary service. <b>Nobody on this team ever asked for a hash table</b>, and there are four of them inside this one request."},{"show":["r","s"],"found":["s"],"say":"First the session token has to become a user. One exact key, no range in it, so it is <b>Act 2</b>: compute the address. The wait is the same whether ten people are logged in or ten million."},{"show":["r","s","i"],"found":["s","i"],"say":"Then the guard: <b>have I already handled this request id?</b> That is Act 6, the set, and it is the only reason a request that got retried does not do its work twice."},{"show":["r","s","i","x"],"found":["s","i","x"],"say":"Then the record itself, fetched by its exact id through an index built for exact keys. <b>That index is a second structure, updated on every single write</b>, which is what the one step read is actually paying for."},{"show":["r","s","i","x","c","n"],"found":["s","i","x","c"],"look":["n"],"say":"And the response cache asks the same shape of question a fourth time. <b>Four one step answers inside one request</b>, and not one of them was designed as a place to keep things."},{"show":["r","s","i","x","c","n","d"],"found":["n"],"bad":["d"],"say":"Then somebody asks for everything from last March. <b>None of the four can answer that at any price</b>, because arithmetic chose those boxes and arithmetic keeps no order. The honest reply is a second structure that does, with its own permanent bill."}]},{"part":"Part 4 · The map","tab":"The map","title":"Act 13 · One question, and three prices","type":"reveal","speed":1650,"viz":{"maxChars":16,"gy":42,"nodes":[{"id":"q","label":"Is the question about ONE EXACT key?","col":0,"row":1,"kind":"gold"},{"id":"n","label":"No: ranges, order, nearest. Chapter 6, not this (Act 1)","col":1,"row":0,"kind":"bad"},{"id":"y","label":"Yes: one step, at any size (Act 2)","col":1,"row":2,"kind":"accent"},{"id":"p1","label":"Price: memory kept empty on purpose (Acts 5 and 7)","col":2,"row":1,"kind":"gold"},{"id":"p2","label":"Price: order, ranges and nearest, gone (Act 6)","col":2,"row":2,"kind":"gold"},{"id":"p3","label":"Price: a rule that mixes the whole key (Act 3)","col":2,"row":3,"kind":"gold"}],"edges":[{"from":"q","to":"n"},{"from":"q","to":"y"},{"from":"y","to":"p1"},{"from":"y","to":"p2"},{"from":"y","to":"p3"}]},"steps":[{"show":["q"],"look":["q"],"say":"One question decides whether this chapter applies at all."},{"show":["q","n"],"bad":["n"],"say":"If there is a range, an order or a nearest in it, <b>this chapter cannot help at any price.</b> That branch belongs to Chapter 6."},{"show":["q","n","y"],"bad":["n"],"found":["y"],"say":"If it is one exact key: <b>one step, and the cost never mentions how much you hold.</b>"},{"show":["q","n","y","p1","p2","p3"],"bad":["n"],"found":["y"],"look":["p1","p2","p3"],"say":"And three prices, all charged always. Memory you keep empty, order you give up, and a rule that genuinely mixes."},{"show":["q","n","y","p1","p2","p3"],"look":["n"],"found":["y","p1","p2","p3"],"say":"And when the answer is no, the honest reply is not a bigger table. <b>It is a second structure that keeps order</b>, paid for on every write, forever. Saying that in week one is worth more than any optimisation in month six."},{"show":["q","n","y","p1","p2","p3"],"bad":["n"],"found":["y","p1","p2","p3"],"say":"<b>Hashing trades memory and order for the one thing nothing else gives you: an answer without a search.</b> The middle price is the one discovered late."}]}]}'></div>
...
<div class="wrap" style="padding-top:34px;">
  ...
  <div class="tbl-wrap"><table>
    ...
    <tr><td>Compute the address</td><td>one step, at any size</td><td>2</td><td>Act 10, where a cache did not, and paid twice</td></tr>
    <tr><td>Two keys, one box</td><td>walking, or a chain in the box</td><td>3, 4</td><td>Act 8, where a full table made walking the normal path</td></tr>
    <tr><td>Load factor</td><td>about half the table, kept empty</td><td>5, 8</td><td>Act 8, the memory saving that removed the speed</td></tr>
    ...
    <tr><td>A set</td><td>one question, no comparison</td><td>6</td><td>Acts 9 and 11, a double charge and a crawler with no memory</td></tr>
    <tr><td>A rule that mixes</td><td>nothing, until it does not mix</td><td>7</td><td>Act 12, four computed addresses inside one ordinary request</td></tr>
    <tr><td>And what it refuses</td><td>order, ranges and nearest, entirely</td><td>1, 13</td><td>The bill, which always arrives late</td></tr>
  </table>
  ...
  <div class="callout warn">
    <div class="ch">And the line from Act 8</div>
