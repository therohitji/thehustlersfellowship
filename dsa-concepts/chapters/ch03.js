...
"3.3": `<div class="wrap">
  ...
  <div class="tbl-wrap"><table>
    ...
    <tr><td>Grow by half when full</td><td>about 3,100</td><td>The same deal, with less waste held and about twice the copying</td></tr>
  </table>
...
"3.4": `<div class="wrap">
  ...
  <p><strong>The chart is walking down a column of a table that was folded by row.</strong> Each of its 100,000 values sits twenty numbers away from the next, so no delivery ever brings two of them, and 100,000 values costs about 100,000 deliveries. Reading the entire table, all twenty columns, would cost about 250,000 deliveries, so this one chart pays for two fifths of a full scan while touching a twentieth of the data. The fix is not a faster chart: store that one column as its own row, and the same 100,000 values arrive in roughly 12,500 deliveries.</p>
...
"3.5": `<div class="wrap">
  ...
  <div class="viz" data-viz='{"type":"card","title":"Two rows, one count, one large multiple","eyebrow":"COUNTED IN TRIPS","badge":"same O(n)","width":510,"rows":[{"k":"16 numbers packed, 16 looks","v":"2 trips","tone":"good","bar":0.125},{"k":"16 numbers scattered, 16 looks","v":"16 trips","tone":"bad","bar":1},{"k":"A million packed, a million looks","v":"125,000 trips","tone":"good","bar":0.125},{"k":"A million scattered, a million looks","v":"1,000,000 trips","tone":"bad","bar":1}],"caption":"Each pair of rows is drawn against its own scale, and in both pairs the packed row is exactly one eighth of the scattered one. Same count, same data, same machine, same shape, decided entirely by what one box was holding."}'></div>
...
<div class="wrap" style="padding-top:34px;">
  ...
  <div class="tbl-wrap"><table>
    ...
    <tr><td>It does not move</td><td>The stale position bill</td><td>6</td><td>Nowhere, and that is the point. It arrives as wrong answers, not as slowness</td></tr>
  </table>
