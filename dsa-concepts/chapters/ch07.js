...
"7.3": `<div class="wrap">
  ...
  <div class="quiz" data-correct="2">
    <div class="q">Why does merging two sorted runs need only one comparison per item placed, when bubble sort spent fifteen moves on the same eight numbers?</div>
...
"7.4": `<div class="wrap">
  ...
  <div class="board" data-anim='{"type":"array-scan","title":"One partition around 5","speed":1600,"big":true,"data":[7,2,9,4,1,5,8,3],"countLabel":" comparisons","pointerLabels":{"mid":"pivot"},"legend":[["being compared with the pivot","look"],["the pivot, now in its final place","found"],["smaller: goes left","seen"],["bigger: parked on the right, never compared with the left again","dead"]],"steps":[{"order":[0,1,2,3,4,5,6,7],"look":[5],"ptr":{"mid":5},"count":0,"say":"Eight numbers, no order. <b>Pick one value and call it the pivot.</b> Here it is the 5, and nothing about choosing it required a comparison."},{"order":[0,1,2,3,4,5,6,7],"look":[0,1],"ptr":{"mid":5},"count":2,"say":"Walk the row and ask one question of each item: <b>are you smaller than 5?</b> 7 is not. 2 is. That is the only question anybody asks in this whole pass."},{"order":[1,3,0,2,4,5,6,7],"seen":[1,3],"look":[4],"ptr":{"mid":5},"count":5,"say":"The smaller ones start gathering on the left. Note what has NOT happened: <b>2 and 4 are on the correct side and in no particular order.</b> One comparison bought a side, not a place."},{"order":[1,3,4,7,5,0,2,6],"seen":[1,3,4,7],"found":[5],"dead":[0,2,6],"count":7,"say":"Seven comparisons, and the pass is done. Left of the pivot: 2, 4, 1, 3. Right of it: 7, 9, 8. <b>Neither side is sorted.</b>"},{"order":[1,3,4,7,5,0,2,6],"found":[5],"seen":[1,3,4,7],"dead":[0,2,6],"count":7,"badge":"5 is finished forever","say":"But look where the 5 is. In the finished row, 1 2 3 4 5 7 8 9, the 5 sits at exactly this position. <b>It was placed permanently by one pass, and it will never be examined again.</b>"}],"caption":"Seven comparisons placed one value forever and split the rest into two groups that never need to be compared with each other. Do the same thing inside each group and the whole row is sorted, having never compared a left-hand item with a right-hand one."}'></div>
  ...
  <p>On the eight numbers from Lesson 7.2, in random order, taking the last item as pivot: <strong>14 comparisons.</strong> Merge sort needed about 24 on the same data, bubble and selection needed 28, and insertion needed 20. So it earns its name.</p>
...
"7.5": `<div class="wrap">
  ...
  <div class="tbl-cap">Radix is the clever one and it is worth seeing why. Sorting a million nine-digit numbers by counting would need a billion tallies. Sorting them one digit at a time needs ten tallies, nine times over, and it only works because each pass preserves the order the previous pass established, which is exactly the stability the board above got for free.</div></div>
...
"7.7": `<div class="wrap">
  ...
  <div class="tbl-cap">Every question in the middle column can be asked in a meeting, without opening any code, and each one points at exactly one lesson of this chapter. That is what a chapter is for: not knowing every algorithm, but knowing which seven questions retire them.</div></div>
  ...
  <div class="callout good">
    <div class="ch">Why this reasoning wins</div>
    <p>It asked the second question of the instrument, which almost nobody asks: <strong>does this need ALL of it ordered?</strong> Caching, faster hardware and a better sorting algorithm all accept the premise that four million rows must be put in order. Once that premise is questioned, the answer is not a faster version of the same work. It is twenty two times less work, and it was hiding in the difference between what the page asked for and what the code went and got.</p>
  </div>
...
"7.8": `<div class="wrap">
  ...
  <div class="les-meta">
    ...
    <span class="pill gold">watch, do not read</span><span class="pill">12 acts</span>
  </div>
  ...
  <p class="lead">Sorting is never the goal, it is the investment you make so that every later question becomes cheap, and this is that argument with the prose taken out. Twelve acts in four parts. Part 2 animates every sorting idea in the chapter on real traces. <strong>Part 3 puts five of them inside a shop page, two dashboards, one import that broke because somebody helpfully sorted the input first, and the sort your language already ships.</strong></p>
</div>

<div class="reel" data-reel='{"title":"Every sort, and who pays for each","speed":1600,"caption":"Twelve acts, about 2 minutes end to end. Part 2 animates every sorting idea in the chapter on real traces. Part 3 runs five of them inside a shop page, two dashboards, one import that broke because somebody helpfully sorted the input first, and the sort your language already ships.","acts":[{"part":"Part 1 · The idea","tab":"An investment","title":"Act 1 · Sorting is never the goal","type":"reveal","speed":1650,"viz":{"maxChars":16,"gy":42,"nodes":[{"id":"s","label":"Sorting: paid once, up front","col":0,"row":2,"kind":"gold"},{"id":"b","label":"Find one thing: 20 looks, not a million","col":1,"row":0,"kind":"accent"},{"id":"r","label":"Everything between two dates","col":1,"row":1,"kind":"accent"},{"id":"g","label":"Duplicates: equal things are neighbours","col":1,"row":2,"kind":"accent"},{"id":"t","label":"The top ten: the last ten boxes","col":1,"row":3,"kind":"accent"},{"id":"w","label":"And the bill: every later insert, forever","col":1,"row":4,"kind":"bad"}],"edges":[{"from":"s","to":"b"},{"from":"s","to":"r"},{"from":"s","to":"g"},{"from":"s","to":"t"},{"from":"s","to":"w"}]},"steps":[{"show":["s"],"look":["s"],"say":"Sorting finds nothing. <b>It is a one-off purchase of an arrangement</b>, made so that every later question becomes cheap."},{"show":["s","b"],"found":["b"],"say":"It buys the twenty looks Chapter 6 spent nine lessons spending."},{"show":["s","b","r","g","t"],"found":["b","r","g","t"],"say":"And three more questions nobody credits it with. <b>One purchase, four different answers.</b>"},{"show":["s","b","r","g","t"],"found":["b","g","t"],"look":["r"],"say":"Each of those three is cheap for a different reason. <b>A date range became one unbroken stretch</b>, so you find the two ends and read between them, and no row outside the answer is ever touched."},{"show":["s","b","r","g","t"],"found":["b","r","t"],"look":["g"],"say":"<b>Equal things became neighbours</b>, so every duplicate is found in one walk down the row instead of holding every row up against every other row."},{"show":["s","b","r","g","t","w"],"found":["b","r","g","t"],"bad":["w"],"say":"And the bill nobody budgets for. <b>One person pays and everybody after them spends it</b>, which is why the decision is so often made badly."},{"show":["s","b","r","g","t","w"],"found":["b","r","g","t"],"bad":["w"],"look":["s"],"say":"So it is an investment, and investments have a break even. On a thousand items it sits at <b>about twenty one searches</b>: ask fewer times than that and the purchase never repays, and scanning was the cheaper answer all along."}]},{"part":"Part 2 · The methods","tab":"Bubble","title":"Act 2 · One comparison, one adjacent pair","type":"array-scan","speed":1400,"big":true,"data":[5,1,4,2,8],"countLabel":" swaps","pointerLabels":{"i":"comparing"},"legend":[["being compared","look"],["travelling","found"],["settled","seen"]],"steps":[{"order":[0,1,2,3,4],"look":[0,1],"ptr":{"i":0},"count":0,"say":"Bubble only ever compares <b>neighbours</b>, so one comparison can settle one adjacent pair and nothing else."},{"order":[1,0,2,3,4],"found":[0],"look":[0,2],"count":1,"say":"5 and 1 swap. Now 5 carries on rightwards, and it will be moved again, and again."},{"order":[1,2,3,0,4],"found":[0],"look":[0,4],"count":3,"say":"Three swaps, and <b>the same value has been moved three times.</b> That is the cost of a comparison that concludes almost nothing."},{"order":[1,2,3,0,4],"found":[0],"seen":[4],"count":3,"badge":"1 pass, 3 swaps","say":"8 is bigger, so 5 stops. On eight items this method spends 28 comparisons and 15 moves."},{"order":[1,2,3,0,4],"look":[2,3],"seen":[4],"ptr":{"i":1},"count":3,"say":"One pass has settled the 8 and nothing else. <b>The 4 and the 2 are still the wrong way round</b>, so the whole row gets walked again from the left."},{"order":[1,3,2,0,4],"found":[3],"seen":[4,0],"count":4,"say":"The 2 moves one box left. <b>Four swaps now, and each walk down the row settles exactly one more box from the right.</b>"},{"order":[1,3,2,0,4],"seen":[1,3,2,0,4],"count":4,"badge":"10 comparisons, 4 swaps","say":"Sorted, after four walks over five values. <b>Ten comparisons bought four swaps</b>, and the 5 alone was carried three boxes by three separate decisions. Every method after this one buys something bigger with the same comparison."}]},{"part":"Part 2 · The methods","tab":"Insertion","title":"Act 3 · The only one that can stop early","type":"array-scan","speed":1400,"big":true,"data":[1,2,3,5,4,6,7,8],"countLabel":" comparisons","pointerLabels":{"i":"this card"},"legend":[["the card being placed","look"],["already in order","seen"],["moved","found"]],"steps":[{"order":[0,1,2,3,4,5,6,7],"look":[1],"seen":[0],"count":1,"say":"Nearly sorted data. Pick up the 2, compare with the 1. <b>Bigger, so it is already home.</b> One comparison, and the search ends."},{"order":[0,1,2,3,4,5,6,7],"look":[3],"seen":[0,1,2],"count":3,"say":"Same for the 3 and the 5. Each costs exactly one comparison and stops."},{"order":[0,1,2,4,3,5,6,7],"look":[4],"found":[4],"seen":[0,1,2],"count":5,"say":"The 4 is smaller than the 5, so it moves one place. <b>This is the only real work in the whole sort.</b>"},{"order":[0,1,2,4,3,5,6,7],"seen":[0,1,2,4,3],"look":[5],"ptr":{"i":5},"count":6,"say":"Now the 6. Compare it with the 5 on its left. Bigger, so <b>the search for its place ends on the first comparison</b> and nothing moves."},{"order":[0,1,2,4,3,5,6,7],"seen":[0,1,2,4,3,5,6],"look":[7],"ptr":{"i":7},"count":8,"say":"The 7, then the 8, one comparison each and both already home. <b>A card bigger than its left neighbour has nothing left to check</b>, which is the only reason this method can finish early."},{"order":[0,1,2,4,3,5,6,7],"found":[0,1,2,4,3,5,6,7],"count":8,"badge":"8, not 28","say":"<b>Eight comparisons and one move.</b> Bubble and selection would both spend twenty eight and never notice the data was nearly sorted."}]},{"part":"Part 2 · The methods","tab":"Merge","title":"Act 4 · One comparison, one item placed forever","type":"array-scan","speed":1500,"big":true,"data":[2,4,7,9,1,3,5,8],"countLabel":" comparisons","pointerLabels":{"lo":"left top","hi":"right top"},"legend":[["the two being compared","look"],["placed, never touched again","found"],["still waiting","seen"]],"steps":[{"order":[0,1,2,3,4,5,6,7],"look":[0,4],"ptr":{"lo":0,"hi":4},"count":1,"seen":[1,2,3,5,6,7],"say":"Two runs, each already in order. <b>Compare only the two fronts.</b> Nothing else needs looking at."},{"order":[4,0,5,1,2,3,6,7],"found":[4,0,5],"look":[1,6],"ptr":{"lo":3,"hi":6},"count":4,"seen":[2,3,7],"say":"1, 2, 3 land. <b>One comparison, one item placed permanently</b>, every single time."},{"order":[4,0,5,1,2,3,6,7],"found":[4,0,5,1],"look":[2,6],"ptr":{"lo":4,"hi":6},"count":5,"seen":[3,7],"say":"The 4 lands. <b>Four items are home and the fifth comparison is already up</b>, and the loser of that one stays exactly where it is and is simply asked again. Nothing is ever carried across the row the way Act 2 carried the 5."},{"order":[4,0,5,1,6,2,3,7],"found":[4,0,5,1,6],"look":[2,7],"ptr":{"lo":5,"hi":7},"count":6,"seen":[3],"say":"The 5 lands. Five of the eight are home, and <b>not one of them has been moved twice.</b>"},{"order":[4,0,5,1,6,2,7,3],"found":[4,0,5,1,6,2,7],"seen":[3],"count":7,"badge":"7 comparisons, 8 items","say":"The 8 lands and the right run is empty. <b>The 9 will be placed with no comparison at all</b>, because there is nothing left it could lose to, and that is why eight items cost seven comparisons rather than eight."},{"order":[4,0,5,1,6,2,7,3],"found":[4,0,5,1,6,2,7,3],"count":7,"badge":"7 comparisons","say":"<b>Seven comparisons for eight items, and nothing was revisited.</b> Bubble moved one value three times in Act 2."}]},{"part":"Part 2 · The methods","tab":"Quick","title":"Act 5 · One comparison buys a side, not a place","type":"array-scan","speed":1500,"big":true,"data":[7,2,9,4,1,5,8,3],"countLabel":" comparisons","pointerLabels":{"mid":"pivot"},"legend":[["being compared with the pivot","look"],["the pivot, now home forever","found"],["smaller: left","seen"],["bigger: parked on the right","dead"]],"steps":[{"order":[0,1,2,3,4,5,6,7],"look":[5],"ptr":{"mid":5},"count":0,"say":"Pick one value, the 5, and call it the pivot. <b>Choosing it cost no comparison at all.</b>"},{"order":[1,3,0,2,4,5,6,7],"seen":[1,3],"look":[4],"ptr":{"mid":5},"count":5,"say":"Ask each item one question: smaller than 5? <b>One comparison buys a side, not a place.</b>"},{"order":[1,3,4,7,5,0,2,6],"seen":[1,3,4,7],"found":[5],"dead":[0,2,6],"count":7,"badge":"5 is home forever","say":"Seven comparisons, and neither side is sorted. But the 5 sits exactly where it sits in the finished row. <b>It will never move again.</b>"},{"order":[1,3,4,7,5,0,2,6],"seen":[1,3,4],"look":[7],"found":[5],"dead":[0,2,6],"ptr":{"mid":3},"count":7,"say":"So do the same thing again, inside the left side only. Pick the 3. <b>Nothing on the left will ever be held up against anything on the right</b>, which is what the first pass bought."},{"order":[1,4,7,3,5,0,2,6],"seen":[1,4,3],"found":[5,7],"dead":[0,2,6],"ptr":{"mid":2},"count":10,"say":"Three more comparisons, and <b>the 3 is home forever too.</b> Ten comparisons in, two of the eight values are permanently placed, and the right side has not been touched once."},{"order":[4,1,7,3,5,0,2,6],"found":[4,1,7,3,5],"dead":[0,2,6],"count":11,"say":"One comparison settles the 2 and the 1, and the whole left half is finished. <b>Eleven comparisons, and the right half still has not been read.</b>"},{"order":[4,1,7,3,5,0,6,2],"found":[4,1,7,3,5,0,6,2],"count":13,"badge":"13 against 28","say":"Two comparisons finish the right half. <b>Thirteen in all, against twenty eight for Act 2 on these same eight numbers</b>, and no left hand value was ever compared with a right hand one."}]},{"part":"Part 2 · The methods","tab":"Counting","title":"Act 6 · Sorted, with nothing compared","type":"array-scan","speed":1500,"big":true,"data":[3,1,4,1,5,2,3,1],"countLabel":" comparisons","pointerLabels":{"i":"counting"},"legend":[["being counted","look"],["already counted","seen"],["placed by its count","found"]],"steps":[{"order":[0,1,2,3,4,5,6,7],"look":[0],"ptr":{"i":0},"count":0,"say":"Eight values, and every one is between 1 and 5. <b>That fact is the whole method.</b>"},{"order":[0,1,2,3,4,5,6,7],"seen":[0,1,2,3,4,5,6,7],"count":0,"badge":"three 1s, one 2, two 3s","say":"One pass, keeping a tally. <b>The counter is still zero</b>, because no item was ever held up against another item."},{"order":[0,1,2,3,4,5,6,7],"look":[1,3,7],"seen":[0,2,4,5,6],"count":0,"badge":"second, fourth, eighth","say":"Before the tally is read back, look at the three 1s. They are the <b>second, fourth and eighth boxes.</b> Predict the order they will come out in, because that answer matters more than the sorting does."},{"order":[1,3,7,5,0,6,2,4],"found":[1,3,7],"seen":[5,0,6,2,4],"count":0,"say":"Three 1s, written straight from the count. <b>Second, fourth, eighth, in exactly that order</b>, because the tally was read front to back. Nobody arranged that and nobody paid for it."},{"order":[1,3,7,5,0,6,2,4],"found":[1,3,7,5,0,6],"seen":[2,4],"count":0,"say":"Then the 2, then the two 3s. <b>The row is being produced rather than rearranged</b>, and the counter has still not moved off zero."},{"order":[1,3,7,5,0,6,2,4],"found":[1,3,7,5,0,6,2,4],"count":0,"badge":"sorted, 0 comparisons","say":"Read the tally back in order. <b>Sorted, and not one comparison happened.</b> The floor every other method obeys is a statement about comparing."}]},{"part":"Part 3 · The same rules in things you used today","tab":"The wrong choice","title":"Act 7 · The courtesy that broke the import","type":"array-scan","speed":1600,"big":true,"data":[1,2,3,4,5,7,8,9],"countLabel":" comparisons","pointerLabels":{"mid":"pivot"},"legend":[["the pivot","look"],["everything, on one side","range"],["the bill, when the split shrinks by one","bad"]],"steps":[{"order":[0,1,2,3,4,5,6,7],"look":[7],"ptr":{"mid":7},"count":0,"badge":"already sorted","say":"<b>This is Act 5, on data that arrived already sorted.</b> The upstream team started sending it that way as a courtesy."},{"order":[0,1,2,3,4,5,6,7],"range":[0,6],"look":[7],"ptr":{"mid":7},"count":7,"say":"The pivot is the last item, which on sorted data is <b>always the largest</b>. So everything goes left and nothing goes right."},{"order":[0,1,2,3,4,5,6,7],"range":[0,5],"look":[6],"bad":[7],"ptr":{"mid":6},"count":13,"say":"The problem shrank by <b>one</b> instead of halving. Seven comparisons bought one item."},{"order":[0,1,2,3,4,5,6,7],"range":[0,4],"look":[5],"bad":[6,7],"ptr":{"mid":5},"count":18,"say":"Again, and again. On sorted data the last item is the largest every single time, so <b>each pass takes exactly one item out of the pile.</b> Eighteen comparisons spent, five still to place, and Act 5 finished all eight in thirteen."},{"order":[0,1,2,3,4,5,6,7],"range":[0,3],"look":[4],"bad":[5,6,7],"ptr":{"mid":4},"count":22,"badge":"seven layers, not three","say":"Eight items should take three layers of halving. <b>This takes seven</b>, and on a real file it is a million layers deep, which is the depth error in the complaint rather than the hours."},{"order":[0,1,2,3,4,5,6,7],"bad":[0,1,2,3,4,5,6,7],"count":28,"badge":"28: the bubble bill","say":"<b>Twenty eight comparisons, which is exactly what bubble sort costs.</b> Nothing changed but the shape of the input, and shuffling the file makes it fast again. That is the diagnosis, not a curiosity."}]},{"part":"Part 3 · The same rules in things you used today","tab":"This is Act 4, on a shop page","title":"Act 8 · Two correct answers, one broken promise","type":"array-scan","speed":1600,"big":true,"data":["a 1","b 3","c 2","d 1","e 3","f 2"],"countLabel":" items placed","legend":[["placed, tie order kept","found"],["placed, tie order lost","bad"],["not the pair being compared","dead"]],"steps":[{"order":[0,1,2,3,4,5],"count":0,"say":"Six products, already sorted by price so a is cheapest. <b>The number is the rating, the letter is the product.</b>"},{"order":[1,4,2,5,0,3],"found":[1,4,2,5,0,3],"count":6,"badge":"stable: b e c f a d","say":"Sorted by rating, stably. Read the letters: <b>inside every rating, the cheaper product still comes first.</b>"},{"order":[4,1,5,2,3,0],"bad":[4,1,5,2,3,0],"count":6,"badge":"unstable: e b f c d a","say":"The same six, sorted by rating with an unstable method. <b>Every rating is still correct.</b> And the price sort has been silently deleted."},{"order":[4,1,5,2,3,0],"bad":[4,1,5,2,3,0],"count":6,"badge":"both pass the test","say":"Neither is a bug in the ordinary sense. <b>Both rows are correctly sorted, and any test asserting order passes on both.</b>"},{"order":[4,1,5,2,3,0],"bad":[0,3],"dead":[4,1,5,2],"count":6,"badge":"a and d, both rated one","say":"Take one pair. <b>a and d are both rated one, and a is the cheaper of the two.</b> The stable row printed a first. This row prints d first, and nothing on the page tells a shopper which of the two they are looking at."},{"order":[1,4,2,5,0,3],"found":[1,4,2,5,0,3],"count":6,"badge":"Act 4 kept it, Act 5 lost it","say":"Nobody adds this behaviour. <b>Act 4 always preferred the left run when two items were equal</b>, so it kept the order it was handed. <b>Act 5 threw items across the row</b> around a pivot, so where a tie lands depends on where it happened to be standing."}]},{"part":"Part 3 · The same rules in things you used today","tab":"This is Act 1, on a dashboard","title":"Act 9 · Four million ordered, ten displayed","type":"array-scan","speed":1500,"big":true,"data":[7,2,9,4,1,8,3,5],"countLabel":" comparisons","pointerLabels":{"i":"asking"},"legend":[["being asked one question","look"],["the ones you are holding","found"],["never ordered, never needed","dead"],["ordered for nobody, in the version that sorted","bad"]],"steps":[{"order":[0,1,2,3,4,5,6,7],"found":[0,1,2],"count":0,"say":"The request is <b>the top three</b>. Hold three. They do not need to be in order among themselves."},{"order":[0,3,2,1,4,5,6,7],"found":[0,3,2],"look":[4],"ptr":{"i":4},"dead":[1],"count":2,"say":"For each remaining value, one question: bigger than the smallest I hold? <b>1 is discarded on one comparison</b> and never looked at again."},{"order":[0,3,2,1,4,5,6,7],"found":[0,3,2],"look":[5],"ptr":{"i":5},"dead":[1,4],"count":3,"say":"Next is 8. <b>Bigger than the smallest I am holding, which is now the 4?</b> Yes, so the 4 leaves and the 8 joins. The three I hold are still in no order at all."},{"order":[0,5,2,1,4,3,6,7],"found":[0,5,2],"look":[6],"ptr":{"i":6},"dead":[1,4,3],"count":4,"say":"Holding 7, 8 and 9. The 3 loses to the smallest of them and <b>is discarded on one comparison, never to be looked at again.</b>"},{"order":[0,5,2,1,4,3,6,7],"found":[0,5,2],"dead":[1,4,3,6,7],"count":5,"badge":"5, not 13","say":"<b>Five comparisons.</b> Sorting all eight costs thirteen. The five faded values were never put in any order, <b>because nobody was going to look at their order.</b>"},{"order":[0,5,2,1,4,3,6,7],"found":[0,5,2],"bad":[1,4,3,6,7],"count":5,"badge":"4,000,000 rows, 10 shown","say":"Now the real one. Sorting four million rows to display ten costs <b>about 88,000,000 comparisons</b>, and the red boxes are the rows it puts in order for nobody. Holding ten and asking each row a single question costs about four million. <b>Twenty two times less work</b>, on the same data, still live."}]},{"part":"Part 3 · The same rules in things you used today","tab":"This is Act 6, on a status dashboard","title":"Act 10 · Four statuses, and the sort that bought nothing","type":"array-scan","speed":1500,"big":true,"data":["shipped","paid","pending","shipped","cancelled","paid"],"countLabel":" comparisons","pointerLabels":{"i":"counting"},"legend":[["being counted","look"],["already counted","seen"],["placed by its tally","found"]],"steps":[{"order":[0,1,2,3,4,5],"look":[0],"ptr":{"i":0},"count":0,"say":"<b>This is Act 6, on a status dashboard.</b> The nightly report sorts every order by status so it can group them, and status can only ever be one of four things."},{"order":[0,1,2,3,4,5],"seen":[0,1,2,3,4,5],"count":0,"badge":"one pending, two paid, two shipped, one cancelled","say":"One pass, keeping four tallies. <b>The counter never leaves zero</b>, because no order was ever held up against another order."},{"order":[2,1,5,0,3,4],"found":[2,1,5,0,3,4],"count":0,"badge":"grouped, 0 comparisons","say":"Read the tallies back in order: pending, paid, shipped, cancelled. <b>Every group is where the report wants it</b>, and nothing was compared to get there."},{"order":[2,1,5,0,3,4],"found":[2,1,5,0,3,4],"count":0,"badge":"twenty minutes, deleted","say":"Lesson 7.5 spent twenty minutes a night buying this order with comparisons. <b>Two passes buy the same screen</b>, and the dashboard cannot tell the difference."}]},{"part":"Part 3 · The same rules in things you used today","tab":"The sort you use","title":"Act 11 · The sort you already use is Acts 3, 4 and 5 at once","type":"reveal","speed":1650,"viz":{"maxChars":16,"gy":42,"nodes":[{"id":"s","label":"The sort your language actually ships","col":0,"row":2,"kind":"dark"},{"id":"r","label":"A stretch already in order? Merge it, never re-sort it","col":1,"row":0,"kind":"accent"},{"id":"i","label":"A piece under about twenty items? Insertion","col":1,"row":1,"kind":"accent"},{"id":"p","label":"Everything else? Partition, and pay for no second copy","col":1,"row":2,"kind":"accent"},{"id":"g","label":"Splitting gone too deep? Change method mid sort","col":1,"row":3,"kind":"bad"},{"id":"o","label":"And nearly sorted input, end to end: close to one pass","col":2,"row":2,"kind":"gold"}],"edges":[{"from":"s","to":"r"},{"from":"s","to":"i"},{"from":"s","to":"p"},{"from":"s","to":"g"},{"from":"r","to":"o"},{"from":"i","to":"o"},{"from":"p","to":"o"},{"from":"g","to":"o"}]},"steps":[{"show":["s"],"look":["s"],"say":"Every act in Part 2 was one method, chosen once. <b>The sort you actually use is none of them</b>, and it decides which one to be while it is running."},{"show":["s","r"],"found":["r"],"say":"First it looks for order that is already there. A stretch of rows that arrived in order is merged rather than sorted, which is <b>Act 4 run on order that nobody paid for.</b>"},{"show":["s","r","i"],"found":["r","i"],"say":"When a piece gets smaller than about twenty items it stops being clever and hands it over. That is <b>Act 3, which genuinely wins at that size</b>, because the splitting costs more than the work saved."},{"show":["s","r","i","p"],"found":["r","i","p"],"say":"Everything else is partitioned, which is <b>Act 5, chosen for needing almost no extra room</b> rather than for being quickest."},{"show":["s","r","i","p","g"],"found":["r","i","p"],"bad":["g"],"say":"And it counts how deep the splitting has gone. If it goes far deeper than halving allows, it abandons partitioning mid sort. <b>That is Act 7 being caught while it happens</b>, so the helpfully sorted file costs a few wasted layers instead of hours."},{"show":["s","r","i","p","g","o"],"found":["r","i","p","o"],"bad":["g"],"say":"On input that arrives nearly in order, which is the most common real input there is, all four decisions collapse to <b>close to a single pass.</b> Not one of them was made by a person, and every one of them is an act you have already watched."}]},{"part":"Part 4 · The map","tab":"The map","title":"Act 12 · Five ways to have an order, and who pays","type":"reveal","speed":1650,"viz":{"maxChars":16,"gy":42,"nodes":[{"id":"q","label":"Does anything read this order?","col":0,"row":2,"kind":"gold"},{"id":"n","label":"No: delete the sort. Nobody pays","col":1,"row":0,"kind":"bad"},{"id":"f","label":"Take the order that already exists. Time, history","col":1,"row":1,"kind":"accent"},{"id":"c","label":"Count into groups. Few values, no comparing","col":1,"row":2,"kind":"accent"},{"id":"s","label":"Keep it as a shape. Every writer pays a little","col":1,"row":3,"kind":"accent"},{"id":"o","label":"Sort once. Whoever sorts pays, then every insert","col":1,"row":4,"kind":"gold"},{"id":"e","label":"And the fourth question: how many times before it changes","col":2,"row":2,"kind":"dark"}],"edges":[{"from":"q","to":"n"},{"from":"q","to":"f"},{"from":"q","to":"c"},{"from":"q","to":"s"},{"from":"q","to":"o"},{"from":"o","to":"e"},{"from":"s","to":"e"}]},"steps":[{"show":["q"],"look":["q"],"say":"One question first, and it is the one most often skipped."},{"show":["q","n"],"bad":["n"],"say":"If nothing reads it, <b>delete the sort.</b> An order with no reader is pure expense."},{"show":["q","n","f","c"],"bad":["n"],"found":["f","c"],"say":"The cheapest order is the one that already happened for another reason. And if a field holds a handful of values, <b>nothing needs comparing at all.</b>"},{"show":["q","n","f","c","s","o"],"bad":["n"],"found":["f","c","s"],"look":["o"],"say":"Keep it as a shape and every writer pays a little forever. Sort it once and whoever sorts pays, and then every later insert pays again."},{"show":["q","n","f","c","s","o"],"bad":["n"],"found":["o"],"dead":["f","c","s"],"say":"Every branch here is an act. <b>Sort once was Acts 2 to 5</b>, four answers to one question about what a single comparison is allowed to buy, and <b>Act 7 was the bill for answering it badly</b>: twenty eight comparisons where thirteen would do, on identical numbers."},{"show":["q","n","f","c","s","o"],"bad":["n"],"found":["c"],"dead":["f","s","o"],"say":"<b>Count into groups was Act 6 and Act 10.</b> Delete the sort was Act 9 answered halfway, where ten rows had a reader and four million did not. And <b>Act 11 was that whole board being decided for you</b>, while the sort ran."},{"show":["q","n","f","c","s","o","e"],"bad":["n"],"found":["f","c","s","o","e"],"say":"<b>Sorting is never the goal. It is the investment you make so that every later question becomes cheap</b>, and the number that decides it is how many times you will ask before the answer changes."}]}]}'></div>
...
<div class="wrap" style="padding-top:34px;">
  ...
  <div class="tbl-wrap"><table>
    ...
    <tr><td>Insertion</td><td>possibly the end of the search, immediately</td><td>3</td><td>Act 11, on every piece under about twenty items</td></tr>
    ...
    <tr><td>Counting</td><td>nothing. It never compares</td><td>6</td><td>Act 10, four statuses on a report that sorted for twenty minutes</td></tr>
